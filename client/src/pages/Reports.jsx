        ...
        <TableContainer component={Paper} sx={{ width: "95%" }}>
          ...
          >
            ...
            <TableBody>
              {show &&
                !attemptsShow &&
                userQuizArr.map((ques, ind) => {
                  return (
                    <SingleQuizRow
                      key={ind}
                      no={ind}
                      openQuizAttempts={setIndexHandler}
                      name={ques.quizDetail.title}
                      mode={ques.quizDetail.quizType}
                      players={ques.attempts.length}
