      ...
      <Card sx={{ maxWidth: 345, mb: 3 }}>
        <CardActionArea>
          <CardMedia
            component="img"
            height="140"
            image={props.img?`http://localhost:5000/${props.img}`:"https://images.unsplash.com/photo-1539628399213-d6aa89c93074?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"}
            alt="quiz image"
          />
          <CardContent>
